...
/// продавцеві, а протокол ніколи не бере більше за оголошену ставку. Дзеркала в
/// `math.ts` не потребує з тієї ж причини, що й origination fee: жодна вимога
/// не просить екран показувати комісію до того, як її утримали.
